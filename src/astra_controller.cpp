...
int jointTypeToInt(astra::JointType joint_type) {
  switch(joint_type) {
    case astra::JointType::Head: return           0;
    case astra::JointType::ShoulderSpine: return  1; /*!< Shoulder spine */
    case astra::JointType::LeftShoulder: return   2; /*!< Left Shoulder */
    case astra::JointType::LeftElbow: return      3; /*!< Left Elbow */
    case astra::JointType::LeftHand: return       4; /*!< Left hand */
    case astra::JointType::RightShoulder: return  5; /*!< Right Shoulder */
    case astra::JointType::RightElbow: return     6; /*!< Right Elbow */
    case astra::JointType::RightHand: return      7; /*!< Right Hand */
    case astra::JointType::MidSpine: return       8; /*!< Mid spine */
    case astra::JointType::BaseSpine: return      9; /*!< Base spine */
    case astra::JointType::LeftHip: return        10; /*!< Left Hip */
    case astra::JointType::LeftKnee: return       11; /*!< Left Knee */
    case astra::JointType::LeftFoot: return       12; /*!< Left Foot */
    case astra::JointType::RightHip: return       13; /*!< Right Hip */
    case astra::JointType::RightKnee: return      14; /*!< Right Knee */
    case astra::JointType::RightFoot: return      15; /*!< Right Foot */
    case astra::JointType::LeftWrist: return      16; /*!< Left Wrist */
    case astra::JointType::RightWrist: return     17; /*!< Right Wrist */
    case astra::JointType::Neck: return           18; /*!< Neck */
    case astra::JointType::Unknown: return        255; /*!< Unknown */
  }
  return -1;
}
